...
# from .routes.analytics_routes import router as analytics_router  # Temporarily disabled
...
# app.include_router(analytics_router)  # Analytics and reporting - Temporarily disabled
